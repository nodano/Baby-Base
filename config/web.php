...
$router->map('POST', 'auth/signup/confirm', 'HTTP\Controller\AuthController::confirm');
$router->map('POST', 'auth/signup', 'HTTP\Controller\AuthController::signup');
...
$router->map('POST', 'listing/confirm', 'HTTP\Controller\ListingController::confirm');
$router->map('POST', 'listing', 'HTTP\Controller\ListingController::listing');
